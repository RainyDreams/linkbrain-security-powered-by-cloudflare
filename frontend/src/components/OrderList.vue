  ...
  <div class="glass-card overflow-hidden">
    ...
    <div v-else class="overflow-x-auto scrollbar-thin">
      <table class="min-w-full text-sm">
        <thead class="bg-slate-100/70 text-xs uppercase tracking-wide text-slate-600">
          <tr>
        ...
        <tbody>
          <tr v-for="o in orders" :key="o.id" class="border-t border-[var(--line)]/70">
            ...
            <td class="px-4 py-3 text-right font-mono" :class="o.side === 'BUY' ? 'text-[var(--pos)]' : 'text-[var(--neg)]'">
            ...
            <td class="px-4 py-3 text-right">
              <button
                ...
                class="rounded-lg border border-cyan-600 px-3 py-1.5 text-xs font-semibold text-cyan-700 transition hover:bg-cyan-50"
